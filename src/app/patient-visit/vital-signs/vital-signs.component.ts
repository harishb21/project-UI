...
export class VitalSignsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.Form=this.formBuilder.group({
      ...
      this.service.getByAppointmentId(this.appointmentId).subscribe((val: { vital_id: number; height: any; weight: any; bloodPressure: any; bodytemperature: any; respirationRate: any; })=>{
  ...
  onSubmit(){
    ...
    this.service.addVitals(vital).subscribe((data: { statusMessage: string | TemplateRef<any>; })=>{
